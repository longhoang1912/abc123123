...
class LeCartWoocommerce(LeCartWordpress):
	...
	def check_product_import(self, convert, product, products_ext):
		product_import_id = self.get_map_field_by_src(self.TYPE_PRODUCT, convert['id'], convert['code'])
		color = convert['att'][0]['value']
		s_color = str(len(color))
		size = convert['att'][1]['value']
		s_size = str(len(size))
		note = convert['att'][2]['value']
		s_note = str(len(note))
		meta_insert = {
			'meta_value': 'a:3:{s:5:"color";a:6:{s:4:"name";s:5:"Color";s:5:"value";s:' + s_color + ':"' + color + '";s:8:"position";s:1:"0";s:10:"is_visible";s:1:"1";s:12:"is_variation";s:1:"0";s:11:"is_taxonomy";s:1:"0";}s:4:"size";a:6:{s:4:"name";s:4:"Size";s:5:"value";s:'+ s_size +':"' + size +'";s:8:"position";s:1:"1";s:10:"is_visible";s:1:"1";s:12:"is_variation";s:1:"0";s:11:"is_taxonomy";s:1:"0";}s:7:"country";a:6:{s:4:"name";s:7:"Country";s:5:"value";s:'+ s_note + ':"'+ note + '";s:8:"position";s:1:"2";s:10:"is_visible";s:1:"1";s:12:"is_variation";s:1:"0";s:11:"is_taxonomy";s:1:"0";}}'
		}
		where_meta = {
			'post_id': product_import_id,
			'meta_key': '_product_attributes',
					}
		self.import_product_data_connector(self.create_update_query_connector('postmeta', meta_insert, where_meta), True, convert['id'])
		return True
